...
public class FormVuelos extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtVuelo, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private boolean validar(){
        ...
        if(!new Validator(txtVuelo).length(7)) return false;
        //Validar que txtCantidad se un número entero entre 40 y 400.
        if(!new Validator(txtCantidad).isInteger(40,400)) return false;
        return true;
    }
